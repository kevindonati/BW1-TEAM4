...
const svgInjection = () => {
  ...
  for (let i = 0; i < starsN; i++) {
    divStar.innerHTML += divStar.innerHTML = `<span onclick="changeStyle(${i + 1})">
        <svg
          width="47"
          height="46"
          viewBox="0 0 47 46"
    ...
    //         fill="#202139" />
    //     </svg>`
    // spanCreation.addEventListener("click", changeStyle)
    // divStar.appendChild(spanCreation)
  }
}
svgInjection()
